...
var InventarioController = /** @class */ (function () {
    function InventarioController(inventarioService) {
        this.inventarioService = inventarioService;
    }
    InventarioController.prototype.actualizarExistencias = function (inventarioId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.inventarioService.actualizarExistencias(inventarioId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    __decorate([
        (0, common_1.Get)('/actualizar-existencias/:inventarioId'),
        __param(0, (0, common_1.Param)('inventarioId')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", Promise)
    ], InventarioController.prototype, "actualizarExistencias", null);
